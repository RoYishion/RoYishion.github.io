<template>
    <div>
        <el-button type="primary" icon="el-icon-edit" @click="addAddress">添加地址</el-button>
        <el-table
            v-loading="loading"
            :data="tableData"
            border
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-button type="info" size="mini" @click="editAddress(scope.row)">编辑</el-button>
                    <el-button
                        @click.native.prevent="deleteAddress(scope.row.addressId, scope.$index, tableData)"
                        type="danger"
                        size="mini">
                    删除
                    </el-button>
        ...
        <el-dialog
            ...
            <span slot="footer" class="dialog-footer" >
                ...
                <el-button type="primary" @click="confirmAddress" :loading='editLoading'>确定</el-button>
            </span>
        </el-dialog>
    </div>
</template>

...
module.exports = app => {
  ...
  router.get('/addPeople', controller.peopleManage.addPeople);
  router.get('/subPeople', controller.peopleManage.subPeople);
  router.get('/updatePeople', controller.peopleManage.updatePeople);
  router.get('/showPeople', controller.peopleManage.showPeople);
};
  ...
  <div>
        ...
        <template slot-scope="scope">
          ...
          <el-button
            @click.native.prevent="
              deleteUser(scope.row.userId, scope.$index, tableData)
            "
            type="danger"
            size="mini"
          >
    ...
    >
      <el-form :model="userForm" ref="forms" :rules="rules">
        ...
        <el-form-item label="学号" prop="userNo" :label-width="formLabelWidth">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="confirmUser" :loading="editLoading"
          >确定</el-button
        >
      </span>
    </el-dialog>
